...
Partial Friend Class frmGlobals
    ...
    Private Sub frmGlobals_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        InitializetxtGlobal()
        InitializelblLabel()
        UpdateGlobalValues(CopyIO.TO_TEMP_ARRAY)
        'If addEvents Then
        '    AddHandler MyBase.MouseMove, AddressOf Form_MouseMove
        '    AddHandler MyBase.Closed, AddressOf Form_Closed
        '    AddHandler Activated, AddressOf frmGlobals_Activated
        'End If
    End Sub
End Class