...
Partial Friend Class frmCoefficients
    ...
    Private Sub frmCoefficients_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'ReLoadForm(False)
        Form_Load()
    End Sub
    ...
    Private Sub Toolbar1_ButtonClick(ByVal eventSender As Object, ByVal eventArgs As EventArgs) Handles Toolbar1_Buttons_Button1.Click, Toolbar1_Buttons_Button2.Click, Toolbar1_Buttons_Button3.Click, Toolbar1_Buttons_Button4.Click, Toolbar1_Buttons_Button5.Click
        ...
        Select Case Button.Text
            Case "Undo"
                ...
                UpdateCoefValues(CopyIO.TO_TEMP_ARRAY)
        ...
        Select Case io
            Case 1 'fill temporary array
                ...
                For j As Integer = 1 To NXk
                    Text1(j - 1).Text = CStr(Xk(j))
                    If j < 13 Then Text1(j + 16).Text = CStr(CvXk(j))
                Next j
            ...
            Case 2 'copy from temporary array back to original values
                ...
                For j As Integer = 1 To NXk
                    Xk(j) = CSng(Text1(j - 1).Text)
                    If j < 13 Then CvXk(j) = CSng(Text1(j + 16).Text)
                Next j
            ...
            Case 3 'set defaults
                ...
                For j As Integer = 1 To NXk
                    Text1(j - 1).Text = CStr(XkDefault(j))
                    If j < 13 Then Text1(j + 16).Text = CStr(CvXkDefault(j))
                Next j
