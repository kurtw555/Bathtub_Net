...
Namespace UpgradeStubs
	...
	Public Class stdole_LoadPictureConstants
		Public Shared Function getdefault() As BT2Support.UpgradeStubs.CopyIO
			...
			Return CopyIO.TO_TEMP_ARRAY
		End Function
		Public Shared Function getMonochrome() As BT2Support.UpgradeStubs.CopyIO
			'UpgradeHelpers.Helpers.NotUpgradedHelper.NotifyNotUpgradedElement("stdole.LoadPictureConstants.Monochrome")
			Return CopyIO.FROM_TEMP_ARRAY
		End Function
		Public Shared Function getVgaColor() As BT2Support.UpgradeStubs.CopyIO
			'UpgradeHelpers.Helpers.NotUpgradedHelper.NotifyNotUpgradedElement("stdole.LoadPictureConstants.VgaColor")
			Return CopyIO.COPY_DEFAULTS
		End Function
	End Class
